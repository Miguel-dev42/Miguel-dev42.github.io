  ...
  render() {
    return (
      <div
        ...
        className={
          (this.props.isClose[this.id] === false && this.props.isFocus[this.id] ? 'bg-white bg-opacity-10 ' : '') +
      ...
      >
        ...
        <img
          ...
          alt=''
        />
        {this.props.isClose[this.id] === false ? <div className=' w-1 h-1 absolute left-0 top-1/2 bg-ub-orange rounded-sm'></div> : null}
        <div
          className={
